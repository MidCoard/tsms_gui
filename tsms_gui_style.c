...
TSMS_RESULT TSMS_GUI_STYLE_init() {
	TSMS_STYLE_DEFAULT = (TSMS_STYLE) {{0, 0, 0, 0, TSMS_COLOR_WHITE}, {0, 0, 0, 0, TSMS_COLOR_WHITE},
	                                   ...
	                                   TSMS_STYLE_AUTO, {TSMS_FONT_TYPE_ARRAY, 1, TSMS_FONT_ARRAY_DEFAULT_FONT},
	...
	TSMS_STYLE_DEFAULT_TEXT = (TSMS_STYLE) {
			...
			TSMS_COLOR_WHITE,TSMS_COLOR_WHITE, TSMS_COLOR_WHITE, TSMS_STYLE_AUTO, TSMS_STYLE_AUTO, TSMS_STYLE_INHERIT, TSMS_STYLE_INHERIT,
			TSMS_STYLE_INHERIT,TSMS_STYLE_INHERIT, {TSMS_STYLE_FONT_TYPE_INHERIT, TSMS_STYLE_FONT_SIZE_INHERIT, TSMS_STYLE_FONT_INHERIT},
