...
TSMS_RESULT TSMS_GUI_STYLE_init() {
	TSMS_STYLE_DEFAULT = (TSMS_STYLE) {{0, 0, 0, 0, &TSMS_COLOR_WHITE}, {0, 0, 0, 0, &TSMS_COLOR_WHITE},
	                                   {0, 0, 0, 0, &TSMS_COLOR_WHITE}, &TSMS_COLOR_WHITE,&TSMS_COLOR_WHITE, &TSMS_COLOR_WHITE, TSMS_STYLE_AUTO,
	                                   TSMS_STYLE_AUTO, TSMS_STYLE_AUTO, TSMS_STYLE_AUTO, TSMS_STYLE_AUTO,
	                                   TSMS_STYLE_AUTO, {TSMS_FONT_TYPE_ARRAY, 1, TSMS_FONT_ARRAY_DEFAULT_FONT, &TSMS_COLOR_BLACK},
	                                   TSMS_STYLE_POSITION_RELATIVE, 0, 0, 0, TSMS_GRID_TYPE_DEFAULT, TSMS_DISPLAY_TYPE_BLOCK
	};

	TSMS_STYLE_DEFAULT_BUTTON = (TSMS_STYLE) {
			{0,2,0,2, &TSMS_COLOR_WHITE}, {2, 2, 2, 2, &TSMS_COLOR_BLACK}, {7, 7, 7, 7, &TSMS_COLOR_WHITE},
			&TSMS_COLOR_WHITE, &TSMS_COLOR_GRAY,  &TSMS_COLOR_WHITE,TSMS_STYLE_AUTO, TSMS_STYLE_AUTO, TSMS_STYLE_INHERIT, TSMS_STYLE_INHERIT, TSMS_STYLE_INHERIT,
			TSMS_STYLE_INHERIT, {TSMS_STYLE_FONT_TYPE_INHERIT, TSMS_STYLE_FONT_SIZE_INHERIT, TSMS_STYLE_FONT_INHERIT, TSMS_STYLE_COLOR_INHERT}, TSMS_STYLE_POSITION_RELATIVE, TSMS_STYLE_INHERIT, 0, 0,
			TSMS_STYLE_GRID_TYPE_INHERIT, TSMS_DISPLAY_TYPE_BLOCK
	};

	TSMS_STYLE_DEFAULT_TEXT = (TSMS_STYLE) {
			{0, 0, 0, 0, &TSMS_COLOR_WHITE}, {0, 0, 0, 0, &TSMS_COLOR_WHITE}, {0, 0, 0, 0, &TSMS_COLOR_WHITE},
			TSMS_STYLE_COLOR_INHERT, &TSMS_COLOR_WHITE, &TSMS_COLOR_WHITE, TSMS_STYLE_AUTO, TSMS_STYLE_AUTO, TSMS_STYLE_INHERIT, TSMS_STYLE_INHERIT,
			TSMS_STYLE_INHERIT,TSMS_STYLE_INHERIT, {TSMS_STYLE_FONT_TYPE_INHERIT, TSMS_STYLE_FONT_SIZE_INHERIT, TSMS_STYLE_FONT_INHERIT, TSMS_STYLE_COLOR_INHERT},
...
TSMS_STYLE TSMS_STYLE_getStyle(pGuiElement element) {
	...
	if (style.gridType == TSMS_STYLE_GRID_TYPE_INHERIT)
		style.gridType = parentStyle.gridType;
	if (parentStyle.displayType == TSMS_DISPLAY_TYPE_NONE)
		style.displayType = TSMS_DISPLAY_TYPE_NONE;
