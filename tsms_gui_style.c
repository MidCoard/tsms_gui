...
TSMS_RESULT TSMS_GUI_STYLE_init() {
	...
	TSMS_STYLE_DEFAULT_BUTTON = (TSMS_STYLE) {
			{5, 5, 5, 5, TSMS_COLOR_WHITE}, {2, 2, 2, 2, TSMS_COLOR_BLACK}, {7, 7, 7, 7, TSMS_COLOR_WHITE},
			TSMS_COLOR_WHITE, TSMS_STYLE_AUTO, TSMS_STYLE_AUTO, TSMS_STYLE_INHERIT, TSMS_STYLE_INHERIT, TSMS_STYLE_INHERIT,
	...
	TSMS_STYLE_DEFAULT_TEXT = (TSMS_STYLE) {
			...
			TSMS_COLOR_WHITE, TSMS_STYLE_AUTO, TSMS_STYLE_AUTO, TSMS_STYLE_INHERIT, TSMS_STYLE_INHERIT,
			TSMS_STYLE_INHERIT,
